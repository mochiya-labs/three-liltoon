...
const SHADOW_BORDER_MASK_FEATURE_DEFINES = [
...
const EMISSION_MASK_FEATURE_DEFINES = [
	...CORE_FEATURE_DEFINES.filter(
		(feature) =>
			!["LIL_FEATURE_REFLECTION", "LIL_FEATURE_DissolveMask"].includes(feature),
	),
...
const forwardSources = {
	vertex: entry("forward"),
	fragment: entry("forward"),
} as const;
...
export const SHADER_VARIANTS: ShaderVariantRecipe[] = [
	...
	},
	{
		...
		sources: forwardSources,
		entries,
		defines: ["LIL_RENDER=1", ...CORE_FEATURE_DEFINES],
	},
	{
	...
	),
	{
		...
		defines: [
			"LIL_RENDER=0",
			...DISSOLVE_NOISE_CORE_FEATURE_DEFINES,
	...
	},
	{
		...
		defines: [
			"LIL_RENDER=0",
			...LAYERED_MATCAP_CORE_FEATURE_DEFINES,
			...LAYERED_MATCAP_FEATURE_DEFINES,
		],
	},
	{
	...
	},
	{
		...
		defines: [
			"LIL_RENDER=0",
			...SURFACE_CONTROL_CORE_FEATURE_DEFINES,
			...LAYERED_SURFACE_CONTROL_FEATURE_DEFINES,
		],
	},
	{
	...
	},
	{
		...
		defines: [
			"LIL_RENDER=0",
			...SHADOW_BORDER_CORE_FEATURE_DEFINES,
			...SHADOW_BORDER_MASK_FEATURE_DEFINES,
		],
	},
	{
