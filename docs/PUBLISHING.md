...
5. Regenerate and manually review `THIRD_PARTY_NOTICES.md`. Compiler tools and Three.js remain development/peer dependencies and are not copied into the runtime package.
