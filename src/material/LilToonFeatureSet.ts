...
function enabled(properties: Record<string, LilToonScalarOrVector>, name: string): boolean {
...
export function detectLilToonFeatures(
  ...
  return {
    ...
    shadow3rd: enabled(properties, "_UseShadow") && colorVisible(properties._Shadow3rdColor),
